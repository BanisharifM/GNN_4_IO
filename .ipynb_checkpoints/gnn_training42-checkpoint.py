...
train_file_path = "Graphs/Graph42/train_graphs.csv"
test_file_path = "Graphs/Graph42/test_graphs.csv"
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('Graphs/Graph42', 'best_model.pt'))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph42', 'loss_chart.png'))
...
plt.ylabel('RMSE')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph42', 'rmse_chart.png'))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph42', 'accuracy_chart.png'))
