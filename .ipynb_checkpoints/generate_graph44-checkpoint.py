...
def load_and_process_data(train_file_path, total_rows, yaml_file_path, test_size=0.5, log_interval=10000):
...
yaml_file_path = "Graphs/Graph44/graph_structure.yaml"
total_rows = 1000000  # You can adjust this value as needed
