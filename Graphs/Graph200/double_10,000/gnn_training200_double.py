...
train_file_path = "Graphs/Graph200/slurm_100,000/train_graphs.csv"
test_file_path = "Graphs/Graph200/slurm_100,000/test_graphs.csv"
...
def log_predictions(predictions, targets, epoch, phase):
    log_dir = 'Graphs/Graph200/slurm_100,000/logs'
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path, update_logs_and_charts):
    ...
    torch.save(model.state_dict(), os.path.join('Graphs/Graph200/slurm_100,000', 'best_model.pt'))
...
def save_plots(train_losses, train_rmse_scores, test_rmse_scores, train_mae_scores, test_mae_scores, train_r2_scores, test_r2_scores):
    plot_dir = 'Graphs/Graph200/slurm_100,000'
...
checkpoint_path = os.path.join('Graphs/Graph200/slurm_100,000', 'checkpoint.pt')
