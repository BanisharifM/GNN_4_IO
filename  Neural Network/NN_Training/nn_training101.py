...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path, update_logs_and_charts):
    ...
    torch.save(model.state_dict(), os.path.join('NN/NN_102', 'best_model.pt'))
...
# Load the data
train_file_path = "NN/NN_102/train_data.csv"
test_file_path = "NN/NN_102/test_data.csv"
...
checkpoint_path = os.path.join('NN/NN_102', 'checkpoint.pt')
