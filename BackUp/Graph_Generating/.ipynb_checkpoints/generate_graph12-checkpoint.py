...
def generate_graph(yaml_path, data_path, save_path):
    ...
    pq.write_table(nodes_table, os.path.join(save_path, 'nodes.parquet'))
    pq.write_table(edges_table, os.path.join(save_path, 'edges.parquet'))
