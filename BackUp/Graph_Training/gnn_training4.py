...
nodes_file_path = 'Graphs/Graph13/nodes_1000.parquet'
edges_file_path = 'Graphs/Graph13/edges_1000.parquet'
...
for epoch in range(num_epochs):
    ...
    model_path = f"Graphs/Graph13/model_epoch_{epoch+1}.pt"
    ...
    plt.tight_layout()
    metrics_path = "Graphs/Graph13/training_metrics.png"
