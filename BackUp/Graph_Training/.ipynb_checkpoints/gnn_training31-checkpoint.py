...
train_file_path = "Graphs/Graph31/train_graphs.csv"
val_file_path = "Graphs/Graph31/val_graphs.csv"
...
def train_and_validate(model, train_loader, val_loader, criterion, optimizer, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), os.path.join('Graphs/Graph31', 'best_model.pt'))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph31', 'loss_chart.png'))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph31', 'accuracy_chart.png'))
