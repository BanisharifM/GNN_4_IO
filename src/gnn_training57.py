...
train_file_path = "Graphs/Graph57/train_graphs.csv"
test_file_path = "Graphs/Graph57/test_graphs.csv"
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path, update_logs_and_charts):
    ...
    torch.save(model.state_dict(), os.path.join('Graphs/Graph57', 'best_model.pt'))
...
checkpoint_path = os.path.join('Graphs/Graph57', 'checkpoint.pt')
