...
train_file_path = "Graphs/Graph50/train_graphs.csv"
test_file_path = "Graphs/Graph50/test_graphs.csv"
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph50', 'loss_chart.png'))
...
plt.ylabel('RMSE')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph50', 'rmse_chart.png'))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph50', 'accuracy_chart.png'))
