...
train_file_path = "Graphs/Graph56/train_graphs.csv"
test_file_path = "Graphs/Graph56/test_graphs.csv"
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path, update_logs_and_charts):
    ...
    torch.save(model.state_dict(), os.path.join('Graphs/Graph56', 'best_model.pt'))
...
checkpoint_path = os.path.join('Graphs/Graph56', 'checkpoint.pt')
