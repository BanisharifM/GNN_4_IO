...
train_file_path = "Graphs/Graph54/train_graphs.csv"
test_file_path = "Graphs/Graph54/test_graphs.csv"
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('Graphs/Graph54', 'best_model.pt'))
...
checkpoint_path = os.path.join('Graphs/Graph54', 'checkpoint.pt')

# Train the model
train_losses, train_rmse_scores, test_rmse_scores, train_mae_scores, test_mae_scores, train_r2_scores, test_r2_scores = train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path)
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph54', 'loss_chart.png'))
...
plt.ylabel('RMSE')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph54', 'rmse_chart.png'))
...
plt.ylabel('MAE')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph54', 'mae_chart.png'))
...
plt.ylabel('R² Score')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph54', 'r2_chart.png'))
