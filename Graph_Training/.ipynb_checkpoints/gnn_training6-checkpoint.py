...
nodes_file_path = 'Graphs/Graph17/nodes_1000.parquet'
edges_file_path = 'Graphs/Graph17/edges_1000.parquet'
...
for epoch in range(num_epochs):
    ...
    if accuracy > best_accuracy:
        ...
        model_path = "Graphs/Graph17/best_model.pt"
    ...
    plt.tight_layout()
    metrics_path = "Graphs/Graph17/training_metrics.png"
