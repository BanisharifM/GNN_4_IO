...
train_file_path = "Graphs/Graph34/train_graphs.csv"
...
def train(model, train_loader, criterion, optimizer, scheduler, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('Graphs/Graph34', 'best_model.pt'))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph34', 'loss_chart.png'))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph34', 'accuracy_chart.png'))
