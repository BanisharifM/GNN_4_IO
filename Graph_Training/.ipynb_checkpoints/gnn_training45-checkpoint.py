...
train_file_path = "Graphs/Graph45/train_graphs.csv"
test_file_path = "Graphs/Graph45/test_graphs.csv"
...
def train(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs, checkpoint_path):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('Graphs/Graph45', 'best_model.pt'))
...
checkpoint_path = os.path.join('Graphs/Graph45', 'checkpoint.pt')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph45', 'loss_chart.png'))
...
plt.ylabel('RMSE')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph45', 'rmse_chart.png'))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(os.path.join('Graphs/Graph45', 'accuracy_chart.png'))
