...
train_nodes_file = 'Graphs/Graph22/train_data_nodes.csv'
val_nodes_file = 'Graphs/Graph22/val_data_nodes.csv'
edges_file = 'Graphs/Graph22/edges.csv'

def load_graph_data(nodes_file, edges_file):
    ...
    for index in graph_indices:
        ...
        # Create edge index
        edge_index = [[node_id_to_index[edge['source']], node_id_to_index[edge['target']]] for _, edge in edges_df.iterrows()]
...
train_data = load_graph_data(train_nodes_file, edges_file)
val_data = load_graph_data(val_nodes_file, edges_file)
...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_accuracy:
        ...
        model_path = "Graphs/Graph22/best_model.pt"
    ...
    plt.tight_layout()
    metrics_path = "Graphs/Graph22/training_metrics.png"
